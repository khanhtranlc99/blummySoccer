...
module.exports = function (options) {
  ...
  const externals = [
    ...
    {
      module_name: './xgame-sdk-vivo-mini.js',
      module_path: './xgame-sdk-vivo-mini.js',
      module_from: 'engine/xgame-sdk-vivo-mini.js'
    },
    {
    ...
    {
      module_name: './xgame-unity-audio-vivo.js',
      module_path: './xgame-unity-audio-vivo.js',
      module_from: 'engine/xgame-unity-audio-vivo.js'
    },
    {
      module_name: './xgame-extension-archive.js',
      module_path: './xgame-extension-archive.js',
      module_from: 'engine/xgame-extension-archive.js'
    }
  ]
  const copyFile = [{
