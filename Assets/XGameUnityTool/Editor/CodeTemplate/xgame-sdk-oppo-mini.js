...
define("platform/oppo-mini/src/ad/BannerInst", ["require", "exports", "h5core/src/H5AdInst", "sdk/src/Const"], function (require, exports, H5AdInst_1, Const_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class BannerInst extends H5AdInst_1.default {
        ...
        doLoad(adId) {
            ...
            this.bannerAd.onLoad(() => {
                // this.onLoad(true, null);
                console.log(this.TAG, "BannerAd onLoad.");
            });
            // 监听系统banner错误
...
define("platform/oppo-mini/src/ad/BannerPos", ["require", "exports", "h5core/src/H5AdBannerPos"], function (require, exports, H5AdBannerPos_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class BannerPos extends H5AdBannerPos_1.default {
        ...
        getFlag(cb) {
            cb(this.banner_inst ? this.banner_inst.getFlag() : false);
        }
    }
    exports.BannerPos = BannerPos;
});
define("platform/oppo-mini/src/ad/CustomInst", ["require", "exports", "h5core/src/H5AdInst", "sdk/src/Const"], function (require, exports, H5AdInst_2, Const_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class CustomInst extends H5AdInst_2.default {
        constructor(sdk, media) {
            super(sdk, Const_2.AdType.custom, "custom");
            this.nativeTmpAd = null;
            this.x = 0;
            this.y = 0;
        }
        setPosition(x, y) {
...
define("platform/oppo-mini/src/ad/CustomPos", ["require", "exports", "h5core/src/H5AdCustomPos"], function (require, exports, H5AdCustomPos_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CustomPos extends H5AdCustomPos_1.default {
        create() {
            ...
            this.custom_inst = this.plan.get_inst(this.pos.media_id);
            return this;
        }
        getFlag(cb) {
            cb(this.custom_inst ? this.custom_inst.getFlag() : false);
        }
        show(result) {
            if (!this.custom_inst) {
                result && result.onError("notAdInst");
            ...
            this.custom_inst.show(result);
        }
        hide() {
            this.custom_inst && this.custom_inst.hide();
        }
    }
...
define("platform/oppo-mini/src/ad/IntersPos", ["require", "exports", "h5core/src/H5AdIntersPos"], function (require, exports, H5AdIntersPos_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("platform/oppo-mini/src/ad/NativeTmpIntersInst", ["require", "exports", "h5core/src/H5AdInst", "sdk/src/Const"], function (require, exports, H5AdInst_3, Const_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class NativeTmpIntersInst extends H5AdInst_3.default {
        ...
        //     if (this.sdkCanvas == null || (scene && scene.getChildByName("sdkCanvas") == null)) {
        //         this.sdkCanvas = new cc.Node("sdkCanvas");
        //         this.sdkCanvas.addComponent(cc.Canvas);
        //         scene && scene.addChild(this.sdkCanvas);
        //     }
        //     return this.sdkCanvas;
        // }
        constructor(sdk, media) {
            super(sdk, Const_3.AdType.native, "customInters");
            this.nativeTmpIntersAd = null;
            // let platform = sdk.Platform();
            // let info = platform.getInfo();
            // let tmp_size: string = media.params.tmp_size;
        ...
        doLoad(adId) {
            ...
            if (info.platformVersionCode < 1094) {
                console.error(this.TAG, "platformVersionCode is lower than 1094.");
                return;
            }
            let screenWidth = info.screenWidth;
            let screenHeight = info.screenHeight;
            let isPortrait = (screenWidth < screenHeight ? true : false);
            if (isPortrait) {
                this.nativeTmpIntersAd = qg.createCustomAd({
                    adUnitId: adId,
                    style: {
                        top: 300,
                        left: 0,
            ...
            this.onLoad(true, null);
            this.nativeTmpIntersAd.onLoad(() => {
                // this.onLoad(true, null);
                console.log(this.TAG, "nativeTmpIntersAd onLoad.");
            });
            this.nativeTmpIntersAd.onError((err) => {
                this.onLoad(false, JSON.stringify(err));
            });
            this.nativeTmpIntersAd.onHide(() => {
                this.hide();
            });
        }
        doShow() {
            if (this.nativeTmpIntersAd) {
                this.nativeTmpIntersAd.show()
                    .then(() => {
                    this.onShow(true, null);
                    // let size = cc.view.getVisibleSize();
                    // this.bgNode = new cc.Node("nativeTmpIntersAdBg");
                    // this.getSdkCanvas().addChild(this.bgNode);
                    // this.bgNode.setPosition(size.width / 2, size.height / 2, 0);
                    // this.bgNode.layer = 1 << 25;
                    // let sprite = this.bgNode.addComponent(cc.Sprite);
                    ...
                    // // @ts-ignore
                    // if (texture._textureReady) {//3.0.1 bug
                    //     // @ts-ignore
                    //     texture._textureReady();
                    // }
                    ...
                    // // sprite.color =
                    // sprite.color = cc.color(0, 0, 0, 150)
                    // this.bgNode.getComponent(cc.UITransform)!.setContentSize(cc.view.getVisibleSize());
                    // this.bgNode.addComponent(cc.BlockInputEvents);
                    // // // 监听原生模板点击 防止背景被点击
                    // // this.bgNode.on(cc.Node.EventType.TOUCH_START, (event) => {
                    // //     console.log(this.TAG, "click bg...");
                    // // });
                })
                    .catch((error) => {
                    this.onShow(false, JSON.stringify(error));
                });
            }
            else {
                this.onShow(false, "nativeTmpIntersAd is null.");
            }
        }
        doHide() {
            if (this.nativeTmpIntersAd) {
                this.nativeTmpIntersAd.offHide();
                this.nativeTmpIntersAd.offError();
                this.nativeTmpIntersAd.offLoad();
                this.nativeTmpIntersAd.destroy();
                this.nativeTmpIntersAd = null;
            }
            // if (this.bgNode) {
...
define("platform/oppo-mini/src/ad/VideoInst", ["require", "exports", "h5core/src/H5AdInst", "sdk/src/Const"], function (require, exports, H5AdInst_4, Const_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let qg = window["qg"];
...
define("platform/oppo-mini/src/ad/VideoPos", ["require", "exports", "h5core/src/H5AdVideoPos"], function (require, exports, H5AdVideoPos_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class VideoPos extends H5AdVideoPos_1.default {
        ...
        getFlag(cb) {
            cb(this.video_inst ? this.video_inst.getFlag() : false);
        }
    }
    exports.VideoPos = VideoPos;
});
define("platform/oppo-mini/src/OppoAdPlan", ["require", "exports", "h5core/src/H5AdPlan", "sdk/src/Const", "platform/oppo-mini/src/ad/BannerInst", "platform/oppo-mini/src/ad/BannerPos", "platform/oppo-mini/src/ad/CustomInst", "platform/oppo-mini/src/ad/CustomPos", "platform/oppo-mini/src/ad/IntersPos", "platform/oppo-mini/src/ad/NativeTmpIntersInst", "platform/oppo-mini/src/ad/VideoInst", "platform/oppo-mini/src/ad/VideoPos"], function (require, exports, H5AdPlan_1, Const_5, BannerInst_1, BannerPos_1, CustomInst_1, CustomPos_1, IntersPos_1, NativeTmpIntersInst_1, VideoInst_1, VideoPos_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OppoAdPlan = void 0;
    const TAG = "XGameH5-OppoAdPlan";
    class OppoAdPlan extends H5AdPlan_1.default {
        constructor(sdk, mgr) {
            super(sdk);
            this.mgr = mgr;
        }
        ...
        create_banner(sdk, media) {
            ...
            if (ad_id) {
                ...
                /*  else if (params.banner_type == "2") {
                    ad = new NativeTmpBannerInst(sdk, media);
                } */
                ad.init(ad_id.split(";"));
                ad.load();
        ...
        create_inters(sdk, media) {
            ...
            if (ad_id) {
                ...
                /* if (params.inters_type == "1") {
                    ad = new IntersInst(sdk, media);
                } else */
                if (params.inters_type == "2") {
        ...
        create_custom(sdk, media) {
            ...
            if (ad_id) {
                let ad = null;
                // if (params.banner_type == "1") {
                //     ad = new BannerInst(sdk, media);
                // }
                ad = new CustomInst_1.default(sdk, media);
                ad.init(ad_id.split(";"));
                ad.load();
                this.mgr.reg_inst(ad);
                return ad;
...
define("platform/oppo-mini/src/OppoMiniAd", ["require", "exports", "h5core/src/H5Ad", "h5core/src/H5AdControl", "h5core/src/H5AdInstMgr", "sdk/src/Const", "platform/oppo-mini/src/OppoAdPlan"], function (require, exports, H5Ad_1, H5AdControl_1, H5AdInstMgr_1, Const_7, OppoAdPlan_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const TAG = "XGameH5-OppoMiniAd";
    class OppoMiniAd extends H5Ad_1.default {
        onModule(sdk) {
            this.sdk = sdk;
        }
        ;
        ...
        parse_ad_plug(channel) {
            if (!this.ad_contrl.getEnable()) {
                console.log(TAG, "ad enable not open.");
                return;
            }
            let plug = channel.getPlug(Const_7.PLUG.oppo_mini);
            if (!plug || !plug.params) {
                console.log(TAG, "no plug or no plug params.");
                return;
            }
            let ad_plan = plug.params.ad_plan;
            if (!ad_plan) {
                console.log(TAG, "no plug params ad_plan.");
                return;
            }
            let sdk = this.sdk;
            this.inst_mgr = new H5AdInstMgr_1.default(sdk);
            this.inst_mgr.init();
            this.ad_plan = new OppoAdPlan_1.OppoAdPlan(sdk, this.inst_mgr);
...
define("platform/oppo-mini/src/OppoMiniPlatform", ["require", "exports", "sdk/src/Const", "h5core/src/H5Platform", "sdk/src/Structs", "sdk/src/Utils"], function (require, exports, Const_8, H5Platform_1, Structs_2, Utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    // 正式
    const ServerUrl = "https://api.xplaymobile.com/xgp_user";
    // 测试
    // const ServerUrl = "http://192.168.31.146/xgp_user";
    const TAG = "XGameH5-OppoMiniPlatform";
    class OppoMiniPlatform extends H5Platform_1.default {
        constructor() {
            super();
            ...
            this.info.win_width = sysInfo.windowWidth;
            this.info.win_height = sysInfo.windowHeight;
            this.info.brand = sysInfo.brand;
            this.info.model = sysInfo.model;
            this.info.language = sysInfo.language;
            this.info.system_version = sysInfo.system;
            this.info.core_version = sysInfo.COREVersion;
            this.info.platform_version_name = sysInfo.platformVersionName;
            this.info.platform_version_code = sysInfo.platformVersionCode;
            this.platformVersionCode = sysInfo.platformVersionCode;
            qg.getManifestInfo({
                success: (res) => {
                    let m = JSON.parse(res.manifest);
                    this.info.app_version = m.app_version;
                    this.info.bundle_id = m.package;
                },
                fail: (err) => { },
        ...
        onInitEnd(success) {
            ...
            //     XplayTracking.initSdk(this.sdk);
            //     XplayTracking.recordStartTime();
            //     this.getDeviceId((succ, deviceId) => {
            //         if (succ) {
            ...
            //     });
            // } else {
            //     console.error(TAG, "platformVersionCode", this.platformVersionCode, "low than 1096.");
            // }
            qg.getManifestInfo({
                success: (res) => {
                    console.log("getManifestInfo success", res.manifest);
                    let obj = JSON.parse(res.manifest);
                    this.app_version = obj.versionName;
                },
                fail: (err) => {
                    console.log("getManifestInfo fail", JSON.stringify(err));
        ...
        getDeviceId(callback) {
            qg.getDeviceId({
                success: (data) => {
                    console.log(TAG, `handling success: ${data.deviceId}`);
                    callback(true, data.deviceId);
                },
                fail: (data, code) => {
                    console.log(TAG, `handling fail, code = ${code}`);
                    callback(false, null);
                },
            });
        }
        ...
        prePayOrder(product_no, success) {
            let send = {
                ...
                "engine_version": qg.getSystemInfoSync().platformVersionCode,
                "token": this.token
            };
            console.log("prePayOrder send", JSON.stringify(send));
            this.user.api("/user/oppo_mini/pre_order", send, (ret, res) => {
                console.log("pre_order:", JSON.stringify(ret), JSON.stringify(res));
                if (ret != "ok") {
                    qg.showToast({ title: ret, icon: "none" });
                    success(ret, res);
                }
                else {
                    success(ret, res);
        ...
        pay(product_no, success) {
            ...
            q.then(() => {
                this.prePayOrder(product_no, (ret, res) => {
                    if (ret != "ok") {
                        qg.showToast({ title: "创建订单失败", icon: "none" });
                        success(ret);
                        q.cancel();
                    }
                    else {
            ...
            q.then((q, data) => {
                ...
                qg.pay({
                    ...
                    complete: (res) => {
                        console.log("qg.pay complete", JSON.stringify(res));
                    }
                });
            });
            q.start();
    ...
    exports.default = OppoMiniPlatform;
});
...
define("platform/oppo-mini/src/config", ["require", "exports", "sdk/src/XGame", "h5core/src/H5User", "h5core/src/H5Channel", "platform/oppo-mini/src/OppoMiniAd", "platform/oppo-mini/src/OppoMiniPlatform"], function (require, exports, XGame_1, H5User_1, H5Channel_1, OppoMiniAd_1, OppoMiniPlatform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    {
        XGameGlobal["xgame.sdk.init.platform"] = (cb) => {
            ...
            sdk.initModules([
                ...
                new OppoMiniPlatform_1.default(),
                new OppoMiniAd_1.default(),
            ]);
            extension_amd_init();
            cb(sdk);
        };
...
define("platform/oppo-mini/src/ad/NavigateDrawerInst", ["require", "exports", "h5core/src/H5AdInst", "sdk/src/Const"], function (require, exports, H5AdInst_5, Const_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class NavigateDrawerInst extends H5AdInst_5.default {
        constructor(sdk, media) {
            super(sdk, Const_9.AdType.custom, "customDrawer");
            this.navigateDrawer = null;
            this.x = 0;
            this.y = 0;
        }
        doInit() {
            this.setting_reloadTimeSpace = 300000;
        }
        setPosition(x, y) {
            this.x = x;
            this.y = y;
        ...
        doLoad(adId) {
            if (this.navigateDrawer) {
                this.navigateDrawer.destroy();
                this.navigateDrawer = null;
            }
            this.adId = adId;
            this.onLoad(true, null);
        ...
        doShow() {
            if (qg.getSystemInfoSync().platformVersionCode < 1090) {
                console.error(this.TAG, "platformVersionCode is lower than 1090");
                return;
            }
            if (!this.navigateDrawer) {
                let info = qg.getSystemInfoSync();
                let screenHeight = info.screenHeight;
                console.log(this.TAG, "设置的参数：", "y:", this.y, "screenHeight:", screenHeight, "top(screenHeight * this.y):", screenHeight * this.y);
                this.navigateDrawer = qg.createGameDrawerAd({
                    adUnitId: this.adId,
                    style: {
                        top: screenHeight * this.y
                    }
                });
            }
            this.navigateDrawer.show().then(() => {
                this.onShow(true, null);
            })
                .catch((err) => {
                this.navigateDrawer.destroy();
        ...
        doHide() {
            this.navigateDrawer && this.navigateDrawer.hide()
                .then(() => {
    ...
    exports.default = NavigateDrawerInst;
});
