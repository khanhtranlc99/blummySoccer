...
{
    [Serializable, TweenAnimation("Transform/PositionSpline", "Transform Position Spline")]
    public class TweenTransformPositionSpline : TweenFloat<SplineFollower>
    {

        public override float current
        {
            get => (float)target.startPosition;
            set
            {
                if (target)
                {
                    target.startPosition = value;
                }
            }
        }
