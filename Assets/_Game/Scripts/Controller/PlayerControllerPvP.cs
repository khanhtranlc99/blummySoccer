...
public class PlayerControllerPvP : Singleton<PlayerControllerPvP>
{
    [Header("Components")]
    ...
    protected void OnBeginDrag()
    {
        ...
        this.TempBall = SimplePool2.Spawn(ballPooling);
    ...
    protected void OnEndDrag()
    {
      ...
      //  CreateController.Instance.SetParentToPool(this.TempBall.gameObject);
        ...
        {
            SimplePool2.Despawn(TempBall.gameObject);
    ...
    public void Fire()
    {
        //Check has ammo
        //Stop Camera Shake
        PvPController.Instance.pvpScene.HandleSubtrackUser();
        if (power >= 0.9f)
        {
