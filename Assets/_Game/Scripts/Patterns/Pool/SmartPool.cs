...
namespace Core.Pool
{
    ...
    public class Pool
    {
        ...
        public Pool(GameObject prefabs, int initQuantify)
        {
            ...
            this._prefabContrainer.transform.SetParent(SmartPool.Instance.transform);
        ...
        public GameObject GetPoolObject(bool active = false)
        {
            GameObject obj;
            ...
            {
                obj = _inactive.Pop();
                if (obj.activeSelf) //be added by Curt
        ...
        public void SetParentToPool(GameObject obj)
        {
            obj.transform.SetParent(_prefabContrainer.transform);
        }
    }
    ...
    /// </summary>
    public class SmartPool : MonoSingleton<SmartPool>
    {
        ...
        public GameObject GetPoolObject(GameObject prefabs, bool active = false)
        {
            if (!prefabs)
            {
                return null;
            ...
            return Instance._pools[prefabs].GetPoolObject(active);
        }
        ...
        /// <summary>
        /// Method to back gameobject to pool parent
        /// </summary>
        /// <param name="prefabs">Gameobject will be set to child back</param>
        public void SetParentToPool(GameObject prefab)
        {
            PoolIdentify poolIndent = prefab.GetComponent<PoolIdentify>();
            ...
            {
                poolIndent.pool.SetParentToPool(prefab);
            }
