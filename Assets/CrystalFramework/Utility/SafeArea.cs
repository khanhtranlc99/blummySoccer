...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField] Vector2Int LastScreenSize = new Vector2Int(0, 0);
        ...
        void Awake()
        {
            ...
            Refresh();
            EventHandler.RegisterEvent(EventID.Rebuild_layout, ApplySizeAfterBanner);
        }
#if UNITY_EDITOR
        void Update()
        {
...
#endif
        // [Button("Apply size")]
        public void ApplySizeAfterBanner()
        {
            //Panel.offsetMax = new Vector2(Panel.offsetMax.x, - AdManager.Instance.GetBannerHeight());
        }
        void Refresh()
        {
