...
public abstract class BaseBox : MonoBehaviour
{
    ...
    [SerializeField] protected bool isCloseBackground;
    [ShowIf("isCloseBackground", true)] [SerializeField] protected Button backgroundButton;
    ...
    private void Awake()
    {
        ...
        if (isCloseBackground && backgroundButton != null)
        {
